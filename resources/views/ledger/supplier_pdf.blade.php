...
<head>
    <meta charset="utf-8">
    <title>Supplier Ledger - {{ $client->name }}</title>
    <style>
        ...
        .header h1 { margin: 0; color: #ea580c; text-transform: uppercase; letter-spacing: 2px; }
        ...
        .credit { color: #dc2626; } /* Payable Increases */
        .debit { color: #059669; }  /* Payable Decreases */
        .summary-row { background-color: #ea580c; color: white; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <table class="info" style="border: none;">
        <tr style="border: none;">
            ...
            <td class="report-info" style="border: none;">
                ...
                <div class="font-bold" style="color: #ea580c; font-size: 14px; margin-top: 5px;">{{ $client->outstandingBalanceLabel() }}</div>
            </td>
        </tr>
    </table>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 13%;" class="text-right">Credit (Purch.)</th>
                <th style="width: 13%;" class="text-right">Debit (Paym.)</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right">-</td>
                <td class="text-right font-bold">{{ number_format(abs($openingBalance), 2) }}</td>
            </tr>
            @foreach ($rows as $row)
                <tr>
                    ...
                    <td class="text-right font-bold">{{ number_format(abs($row['balance']), 2) }}</td>
                </tr>
            @endforeach
