                        ...
                        <tbody class="divide-y divide-gray-100">
                            <template x-for="(item, index) in items" :key="index">
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    <td class="px-4 py-3">
                                        <select :name="`items[${index}][lot_id]`" x-model="item.lot_id" @change="updateLotInfo(index)"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <input type="number" name="discount" x-model.number="discount" step="0.01"
                                   class="w-32 text-right rounded-lg border border-gray-300 px-3 py-2 text-sm font-mono focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none">
                        </div>
